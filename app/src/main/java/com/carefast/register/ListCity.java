...
public class ListCity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(ListCity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void initSpinnerCity() {
        ...
        mApiService.city_get(provinceid).enqueue(new Callback<CityResponse>() {
            @Override
            public void onResponse(Call<CityResponse> call, Response<CityResponse> response) {
                if (response.isSuccessful()) {
                    List<CityItem> cityItems = response.body().getCity();
                    adapter = new CityAdapter(ListCity.this, cityItems, genProductAdapterListener());
                    rvprov.setAdapter(adapter);
                    adapter.notifyDataSetChanged();
                } else {

                    Toast.makeText(ListCity.this, "Gagal mengambil data", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<CityResponse> call, Throwable t) {
                ...
                Toast.makeText(ListCity.this, "Koneksi internet bermasalah", Toast.LENGTH_SHORT).show();
            }
        });
    }
